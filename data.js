...
},
{
  ...
  //
  //        光によって空間を消し去ること。<br>                            ミースがアメリカで"構造"に導かれたのは<br>                            このような存在のイメージからだ。<br><br>                            "あること"と"ないこと"の狭間のような移ろいゆく曖昧な光の世界。<br><br>                            そして、バルセロナ・パビリオンの現れては消える光の中にミースが求めたのは、<br>                            まさにこの、存在の〈希薄さ〉と〈豊かさ〉なのである。
...
},
{
  ...
  //        "WaterDropsで<br>目の前の小さな行動と成果を視覚化し、<br>ゲーム感覚で、タスクをこなそう。"
...
},
{
  ...
  //        "マインドフルネス時代のメモ<br>ぐるぐる、ぐるぐる、画面をなぞって、タスクを登録<br>                            完了したら長押し＝爆破で達成！！<br>                            いろんなかたちのグルグルをつくって<br>                           自分だけの美しいタスクスペースを描こう！"
...
// {
//   id: 12,
//   title: "雨が生まれるとき 〔空間アイデアコンペ〕",
//   category: "space",
//   imgPaths: ["raincome_0.jpg", "raincome_1.jpg"],
//   date: "2000.01",
//   description: "アイデアコンペ応募<br>微細な空間イメージを提案",

//   //        "雨にかたちはない<br>                            雨つぶが連なり大気の一体となって<br>                            質量をつくって舞い降りる<br>                            雨は1回だけの情景をつくる",
//   urls: [],
// },
...
//        title: "Draft",
//        category: "iOS",
//        imgPaths: ["draft_0.jpg", "draft_1.jpg", "draft_2.jpg", "draft_3.jpg"],
//        date: "2018.7 release",
//        description: "枠にとらわれずに、サクサクと軽快な思考をしよう。<br>                            鋭いインスピレーションを得るのに必要なのは、<br>                            自由かつシンプルであること。<br>思考の重荷を外して<br>ゼロベースで柔軟に世界と向き合ってみよう。",
//        urls: [],
//  },
//    {
//        id: 17,
...
//        category: "iOS",
//        imgPaths: [
//      "AgreementCounter_0.jpg",
//      "AgreementCounter_1.jpg",
//      "AgreementCounter_2.jpg",
//      "AgreementCounter_3.jpg",
//    ],
//        date: "2016.7 release",
//        description: "「成約」と「達成」をカウントして、<br>自分に報酬を与えよう！<br><br>                  達成のステップをジェスチャで瞬時にカウントし<br>目を見張る成果を実感しよう！<br>                            営業マン、ビジネスマン、学生、主婦など、<br>モチベーションを上げたいすべての人にオススメ。",
//        urls: [],
//  },
...
//        title: "kukei",
//        category: "space",
//        imgPaths: ["kukei_0.jpg", "kukei_1.jpg", "kukei_2.jpg"],
//        date: "2000.01",
//        description: null,
//        urls: [],
//  },
{
  ...
  //        "完了タスクが水に変わりスッキリ！<br>                         タスクを爆破して、頭の中を空っぽにしよう！                        <br><br>爽快感パンパなし！ゲーム型タスクアプリ！<br>                          完了した〝タスクドロップ〟を壁にぶつけて壊すと                    透き通った水に変わって、器を満たしていきます。<br>                            水をどんどん貯めてあなたの心も満たしましょう。"
  urls: [],
},
{
  id: 16,
...
//   imgPaths: ["anns.jpg"],
//   date: "2003.01",
//   description: '雑誌「花時間」応募<br><br><span style = "color:#00c3ff">2003 年1月 花時間掲載（Web）</span>',
//   urls: [],
// },
...
//   title: "継承の家",
//   category: "space",
//   imgPaths: ["keisyo_0.jpg", "keisyo_1.jpg"],
//   date: "1998.04",
//   description:
//     "住友林業　人と自然ともに生きる住まい対象<br><br>100年後の人と自然を視野に入れて創造する木の住まい",
//   urls: [],
// },
// {
//   id: 21,
